                 ...
                 Container(
                   ...
                   child: Padding(
                    ...
                    child: DropdownButton<String>(
                     ...
                     isExpanded: true,
                      icon: null,
                      value: dropdownValue == "" ? null : dropdownValue,//dropdownValue,
                       hint: const Text('Select type',
                         style: TextStyle(color: Colors.grey,fontSize: 16),),
                       items: <String>['Amc', 'Chargable', 'Warranty',]
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      DropdownButton(
                        underline: Container(),
                        hint: const Text("Select Product/Services",
                          style: TextStyle(color: Colors.grey,fontSize: 16),
                        ),
                  ...
                  ConstrainedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                       // registerComplainApi();
                        if(NameController.text==''||MobileController.text==''||AddressController.text==""||
                            dropdownValue==""||_mySelection==null){
                          Get.snackbar('Failed', 'Text Field is empty, Please Fill All Data');
                        }else{
                          registerComplainApi();
                        }
                      },
