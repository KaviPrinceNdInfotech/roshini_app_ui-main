...
class PdfInvoiceApi {
  ...
  static Widget buildVendorAddress(Vendor vendor) => Column(
    ...
    children: [
      ...
      Text(vendor.name, style: TextStyle(fontSize: 14,fontWeight: FontWeight.normal)),
      SizedBox(height: 1 * PdfPageFormat.mm),
      Text(vendor.email, style: TextStyle(fontSize: 14,fontWeight: FontWeight.normal)),
      SizedBox(height: 1 * PdfPageFormat.mm),
      Text(vendor.address, style: TextStyle(fontSize: 14,fontWeight: FontWeight.normal)),
      SizedBox(height: 1 * PdfPageFormat.mm),
  ...
  static Widget buildSupplierAddress(Supplier supplier) => Column(
        ...
        children: [
          ...
          SizedBox(height: 1 * PdfPageFormat.mm),
          Text(supplier.name, style: TextStyle(fontSize: 14,fontWeight: FontWeight.normal)),
          SizedBox(height: 1 * PdfPageFormat.mm),
          Text(supplier.email, style: TextStyle(fontSize: 14,fontWeight: FontWeight.normal)),
          SizedBox(height: 1 * PdfPageFormat.mm),
          Text(supplier.address, style: TextStyle(fontSize: 14,fontWeight: FontWeight.normal)),
          SizedBox(height: 1 * PdfPageFormat.mm),
          Text(supplier.mobile, style: TextStyle(fontSize: 14,fontWeight: FontWeight.normal)),
          SizedBox(height: 1 * PdfPageFormat.mm),
          Text(supplier.pin, style: TextStyle(fontSize: 14,fontWeight: FontWeight.normal)),
        ],
      );
